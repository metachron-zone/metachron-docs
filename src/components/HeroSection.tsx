...
export function HeroSection() {
  ...
  return <section className="min-h-screen py-20 pt-20 flex flex-col justify-center relative overflow-hidden">
      <MatrixRain />
      <div className="absolute inset-0 bg-[#0B0F19] z-0">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#00B5AD]/10 via-transparent to-transparent z-0" />
        <div className="absolute -bottom-48 -right-48 w-96 h-96 bg-[#00B5AD]/10 rounded-full blur-3xl z-0" />
      </div>
