...
import { BrainCircuit, LineChart, Users } from 'lucide-react';
        ...
        <div ref={featuresRef} className={`transition-all duration-1000 ease-out ${isFeaturesVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              METACHRON 提供全方位的 Agent
              开发与管理解决方案，从创建到优化，再到生态协作
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <FeatureCard icon={<BrainCircuit className="w-10 h-10 text-[#00B5AD]" />} title="智能Agent生成工坊" description="通过自然语言描述需求，自动生成技术规格文档，组件智能装配系统结合预置工具库自动匹配最佳方案" image="/agent_workshop.png" />
